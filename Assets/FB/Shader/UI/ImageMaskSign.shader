...
Shader "FB/UI/ImageMaskSign"
{
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#pragma target 2.0
            #pragma multi_compile _DUMMY _ALPHATEX_ON
            ...
            half4 frag(v2f IN) : SV_Target
            {
                ...
                #ifdef _ALPHATEX_ON
                    color.a = SAMPLE_TEXTURE2D(_MaskTex, sampler_MaskTex, IN.texcoord.xy).a * SAMPLE_TEXTURE2D(_AlphaTex, sampler_AlphaTex, IN.texcoord.zw).r;
                #else
                    color.a = SAMPLE_TEXTURE2D(_MaskTex, sampler_MaskTex, IN.texcoord.xy).a * SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.texcoord.xy).a;
                #endif
                color *= IN.color;
