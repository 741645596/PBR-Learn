...
Shader "FB/UI/ImageEx"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				half4 color;
				color.rgb = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.texcoord.xy).rgb;
				color.a = SAMPLE_TEXTURE2D(_AlphaTex, sampler_AlphaTex, IN.texcoord.zw).r;
				color *= IN.color;
