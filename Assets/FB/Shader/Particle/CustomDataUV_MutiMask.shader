Shader "FB/Particle/CustomDataUV_MutiMask"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //float4 _Mask2Tex_ST, _MainTex_ST, _MaskTex_ST, _DistortTex_ST;
            ...
            UNITY_INSTANCING_BUFFER_START(Props)
                ...
                UNITY_DEFINE_INSTANCED_PROP(float, _uvM2SpeedX)
                UNITY_DEFINE_INSTANCED_PROP(float, _uvM2SpeedY)
            ...
            v2f vert(appdata v)
            {
                ...
                o.uv.xy = UVTilingOffset(toggle, _MainTex_TilingOffset_Value) + lerp(0, customData1, _ToggleCustom_Value);
                    ...
                    float  _TextureScaleXMask2_Value = UNITY_ACCESS_INSTANCED_PROP(Props, _RotatorAngleMask2);
                    ...
                    o.uvMutiMask.xy = UVTilingOffset(toggleMask2, _Mask2Tex_TilingOffset_Value) + float2(UNITY_ACCESS_INSTANCED_PROP(Props, _uvM2SpeedX), UNITY_ACCESS_INSTANCED_PROP(Props, _uvM2SpeedY)) * _Time.g;
                #endif
                #if defined(UNITY_INSTANCING_ENABLED)
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                //  distort
                    ...
                    half _DistortTexRepeatU_Value = UNITY_ACCESS_INSTANCED_PROP(Props, _DistortTexClamp);
                ...
                half _MainTexRepeatU_Value = UNITY_ACCESS_INSTANCED_PROP(Props, _MainTexClamp);
                ...
                half4 maskColor = half4(1,1,1,1);
                    ...
                    float2 uvMask = GetUV(i.uv2.zw, _MaskTexClamp_Value, _MaskTexRepeatU_Value, _MaskTexRepeatV_Value, _MaskTex_TilingOffset);
