Shader "FB/Particle/DistortSHDissolveMask"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutput vert(VertexInput v)
            {
                ...
                float2 anim = float2(_DissUSpeed * _Time.g, _DissVSpeed * _Time.g);
                ...
                o.uv0.zw = TRANSFORM_TEX(toggle, _MainTex);
                o.uv0.xy = TRANSFORM_TEX(v.uv.xy, _DistortTex) + anim2;
                o.uv1.xy = TRANSFORM_TEX(v.uv.xy, _Disstex)+ anim;
