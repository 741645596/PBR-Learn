Shader "FB/Particle/Fresnel"
{
    Properties
    {
        ...
        [MainTexture][MainTexture]_MainTex ("Main tex", 2D) = "white" { }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput i) : COLOR
            {
                ...
                //float4 fresnel = (pow(saturate(dot(normalDirection, worldViewDir)), _FresnelRange * 3) * _Fresnelintensity * 2) * _FresnelColor;
                half fresnel;
                ...
                finalColor += fresnelColor* i.vertexColor.a;
